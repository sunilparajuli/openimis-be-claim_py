...
def check_claim_max_no_category(base_category, product, expiry_date, insuree_id,
    ...
    category_dict = {
        ...
        'S': {"max": product.max_no_surgery,
              "reason": "claim.validation.product_family.max_nb_surgeries",
              "message": REJECTION_REASON_MAX_SURGERIES},
        'D': {"max": product.max_no_delivery,
              "reason": "claim.validation.product_family.max_nb_deliveries",
              "message": REJECTION_REASON_MAX_DELIVERIES},
        'A': {"max": product.max_no_antenatal,
              "reason": "claim.validation.product_family.max_nb_antenatal",
              "message": REJECTION_REASON_MAX_ANTENATAL},
        'H': {"max": product.max_no_hospitalization,
              "reason": "claim.validation.product_family.max_nb_hospitalizations",
              "message": REJECTION_REASON_MAX_HOSPITAL_ADMISSIONS},
        'V': {"max": product.max_no_visits,
              "reason": "claim.validation.product_family.max_nb_visits",
              "message": REJECTION_REASON_MAX_VISITS},
    }.get(base_category)
